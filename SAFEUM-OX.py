...
a_bSa = '\033[1;32m'
faB_s = '\033[2;32m'
a_aB_s = '\033[2;39g y m'
Ba_bS = '\033[2;36m'
Ya_Bs = '\033[1;34m'
S_aBs = '\033[1;33m'
ab = pyfiglet.figlet_format("×͜×JUTT×͜×")
print(a_bSa + ab)
...
to(
    f"\033[31;m Script Type>> \033[1;36mSafeUm Vip Account Generetor JUTT BRAND\n\033[1;31m Script\n\033[31;m Time >>\033[1;33mUnlimited\n\033[31;m")
print('')
print('\033[32;m')
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            with open('SafeUM-Accounts.txt', 'a') as f:
                f.write(RJTUFANTEAM + ":hhhh | TG : JUTT\n")
...
while True:
    ...
    if int(success) > int(0):
        ...
        print("Account Generated>> DAVLOpEr : RAVI BRAND\n", z)
